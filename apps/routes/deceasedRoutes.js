...
} = require('../deceased-service/src/controllers/deceasedControl');
const {
  nextOfKinRegister,
} = require('../deceased-service/src/controllers/nextOfKInControl');
const {
  registerAutopsy,
} = require('../deceased-service/src/controllers/autopsyControl');
const {
  deathCauseClassifications,
} = require('../deceased-service/src/controllers/analysis');
